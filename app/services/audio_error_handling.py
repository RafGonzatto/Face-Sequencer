...
from app.core.audio.audio_exceptions import AlignmentError, map_audio_processing_error
from app.core.utils.config import config  # use configured allowed extensions
    ...
    def decorator(func):
        ...
        def wrapper(*args, **kwargs):
            ...
            try:
                ...
                try:
                    from app.core.utils.api_responses import error_response  # Local import to avoid circular issues
                ...
                from flask import jsonify
                try:
                    from app.core.utils.api_responses import error_response  # local import
                    body = error_response(
                        str(e),
...
def _detect_speech_activity_fallback(file_path):
    ...
    try:
        ...
        print(f"[WARNING]  Warning: Speech detection failed, assuming audio contains speech: {e}")
        return {
