...
class AudioManager {
  ...
  bindEvents() {
    ...
    if (this.timingModeToggle) {
      ...
      console.warn(
        "AudioManager: timingModeToggle not found (timing toggle disabled)"
      );
    }
  ...
  uploadAudio() {
    ...
    const container =
      this.waveContainer || this.uploadAudioBtn?.parentElement || document.body;
    ...
    xhr.onerror = () => {
      ...
      this.app?.reportError("Audio upload network error", {
