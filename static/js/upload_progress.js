  ...
  function ensureBar(container) {
    ...
    if (!bar) {
      ...
      wrapper.style.cssText =
        "position:absolute;left:0;right:0;bottom:0;height:4px;background:rgba(255,255,255,0.15);z-index:60;";
      const inner = document.createElement("div");
      inner.id = "inlineUploadProgress";
      inner.style.cssText =
        "height:100%;width:0%;background:#3b82f6;transition:width .15s linear;";
