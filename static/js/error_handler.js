...
(function(){
  ...
  const TYPE_HINTS = {
    ...
    alignment_error: 'Verifique se o texto corresponde ao áudio e reduza ruído de fundo.',
    ...
    unexpected_error: 'Tente novamente. Se persistir, verifique logs do servidor.'
  };
  ...
  function handleEnvelope(env, opts){
    opts = opts || {};
    try {
      if(!window.app && !opts.toasts){ return; }
    ...
    } catch(e){ console.warn('Error handler exception', e); }
  }
